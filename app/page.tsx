    ...
    <>
      ...
      <div className="bg-white min-w-[320px]">
        ...
        */}
        ...
        {/* What we do Section */}
          <section className="mb-4 w-full min-h-screen mt-44 "> 
            <p className="header"> Our Services </p>
            <p className="subheader"> We are dedicated to delivering tailor-made technology solutions that precisely align with your unique business needs. </p>
        ...
        {/* Product Gallery  */}
          ...
          <section className="mt-24">
            ...
            <p className="py-6 text-2xl text-center font-semibold"> Feel free to reach out and one of our teammates will get back to you as soon as possible. </p>
            <div className="flex justify-center">
              <button className="px-28 py-5 bg-black text-white rounded align-center text-xl">
                Contact Us
              </button>
