  ...
  return (
    <div className="relative w-full mx-auto mt-0">
      ...
      >
        ...
        />
        <div className="absolute p-4 h-auto w-full z-10 bg-white bg-opacity-80 bottom-0 ">
          <div className="flex justify-between items-center w-full py-4 px-6">
            <div className="flex-col">
            <p className=" text-black font-bold text-3xl font-montserrat"> { images[currentIndex].title} </p>
            <p className="text-black font-montserrat"> { images[currentIndex].subtext} </p>
            </div>
            <Link href={ images[currentIndex].linkto} passHref className="absolute right-0 object-center px-6 hidden md:block">
