                ...
                <ul className="flex flex-col items-start gap-y-4 p-8">
                  <li className="relative">
                    ...
                    {isMobileDropdownOpen === "About" && (
                      <div className="fixed top-0 left-0 w-2/3 h-full bg-white text-black shadow-lg transition-transform transform translate-x-0 z-50">
                        <button
                          className="absolute top-4 right-4 focus:outline-none"
                          onClick={() => toggleMobileDropdown("About")}
                        >
